...
class BackpackServiceProvider extends ServiceProvider
{
    ...
    public function publishFiles()
    {
        ...
        $backpack_menu_contents_view = [
            __DIR__.'/resources/views/base/inc/sidebar_content.blade.php'      => resource_path('views/vendor/ggg3/base/inc/sidebar_content.blade.php'),
            __DIR__.'/resources/views/base/inc/topbar_left_content.blade.php'  => resource_path('views/vendor/ggg3/base/inc/topbar_left_content.blade.php'),
            __DIR__.'/resources/views/base/inc/topbar_right_content.blade.php' => resource_path('views/vendor/ggg3/base/inc/topbar_right_content.blade.php'),
        ];
    ...
    {
        $customBaseFolder = resource_path('views/vendor/ggg3/base');
        $customCrudFolder = resource_path('views/vendor/ggg3/crud');
